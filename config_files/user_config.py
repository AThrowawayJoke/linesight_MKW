...
Note that there is an additional config file located in mkw-scripts/mkw_config.py for the MKW file.
"""
...
game_path = "C:\\Games\\Dolphin-x64\\Games\\MKW Copies\\Mario_Kart_Wii.rvz"
...
track_start_state_path = trackmania_base_path / "rGV2_Start.sav"
