...
def get_wiimote_pointer(controller_id: int, /) -> (float, float): # type: ignore
    """
...
def get_wiimote_acceleration(controller_id: int, /) -> (float, float, float): # type: ignore
    """
...
def get_wiimote_swing(controller_id: int, /) \
        -> (float, float, float, float, float, float, float): # type: ignore
    """
...
def get_wiimote_shake(controller_id: int, /) \
        -> (float, float, float, float, float): # type: ignore
    """
...
def get_wiimote_tilt(controller_id: int, /) \
        -> (float, float, float, float): # type: ignore
    """
