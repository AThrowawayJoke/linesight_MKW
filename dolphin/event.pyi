...
def on_framedrawn(callback: Callable[[], None] | None) -> None:
    """
    Registers a callback to be called every time the game has drawn a new frame.
    """


async def framedrawn() -> None:
    """
    Awaitable event that completes once the game has drawn a new frame.
    """
